...
- **Cookie leakage**: Cookies are never transmitted to the backend. Stored in App Group UserDefaults — sufficient for this threat model.
...
- Never store cookies in standard UserDefaults — App Group only
